...
if (isset($_POST['cari'])) {
    ...
    $pemasok = query("SELECT * FROM  pemasok WHERE 
        nama_pemasok LIKE '%$keyword%' OR 
        alamat_pemasok LIKE '%$keyword%' ");
} else {
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <form method="POST" class="card-tools d-flex align-items-center">
                            ...
                            <a href="form_pemasok.php" class="btn btn-sm btn-primary ml-2">Tambah</a>
                        </form>
                    </div>
                        ...
                        <table class="table table-striped">
                            <thead>
                                <tr>
                                    ...
                                    <th>Nama</th>
                                    <th>Alamat</th>
                                    <th style="width: 180px">No. Telpon</th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php $i = 1; ?>
...
<script>
    ...
    function gotoForm(id) {
        window.location.href = 'form_pemasok.php?id=' + id
    }
</script>